        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-12 text-center">
              <p className="cash-app">CASH APP</p>
            ...
            <div className="footer-top">
              <div className="row">
                <div className="col-md-6 col-lg-3 about-footer">
                  <button type="button" className="btn btn-dark me-3"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 20 24" fill="none">
                  ...
                  </svg>APP STORES</button>
                  <button type="button" className="btn btn-dark"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 20 22" fill="none">
